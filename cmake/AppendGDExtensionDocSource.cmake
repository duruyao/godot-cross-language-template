...
function(append_gdextension_doc_source EXTENSION_TARGET GODOTCPP_SRC_DIR EXTENSION_DOC_DIR)
    ...
    file(RELATIVE_PATH extension_doc_dir_rel_path "${CMAKE_CURRENT_SOURCE_DIR}" "${EXTENSION_DOC_DIR}")
    set(doc_source "${CMAKE_CURRENT_BINARY_DIR}/${extension_doc_dir_rel_path}/gen/${extension_target_id}.doc.cpp")
